...
int PALIAL_dormqr (int side, int transpose, int tileA_size, const double *tileA, int lda, const double *tileS, int lds, double *tileB, int ldb, double *workspace, int ldw)
{
    int gamma, i1, i3;
